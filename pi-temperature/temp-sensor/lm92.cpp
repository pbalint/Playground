...
LM92::LM92( const std::string& device, short address )
{
    fd = open( device.c_str(), O_RDWR );
    if ( fd < 0 )
    {
        throw "Can't open I2C device: " + device + "\n";
    }

    if ( ioctl( fd, I2C_SLAVE, address ) < 0 )
    {
        throw "Can't set I2C address: " + to_string( address ) + "\n";
    }
...
unsigned short LM92::Read16()
{
    ...
    {
        throw "Unable to read from device\n";
    }
